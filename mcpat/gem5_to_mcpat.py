...
STAT_MAP = {
    ...
    "rename_reads":         {"confidence": "soft", "keys": ["board.processor.cores.core.rename.int_rename_lookups", "system.cpu.rename.int_rename_lookups", "system.cpu.rename.RenameLookups"]},
    "rename_writes":        {"confidence": "soft", "keys": ["board.processor.cores.core.rename.RenamedOperands", "system.cpu.rename.RenamedOperands"]},
    "fp_rename_reads":      {"confidence": "soft", "keys": ["board.processor.cores.core.rename.fp_rename_lookups", "system.cpu.rename.fp_rename_lookups"]},
    "fp_rename_writes":     {"confidence": "soft", "keys": ["board.processor.cores.core.rename.RenamedInsts", "system.cpu.rename.RenamedInsts"]},
    "iq_reads":             {"confidence": "soft", "keys": ["board.processor.cores.core.iq.int_inst_queue_reads", "system.cpu.iq.int_inst_queue_reads"]},
    "iq_writes":            {"confidence": "soft", "keys": ["board.processor.cores.core.iq.int_inst_queue_writes", "system.cpu.iq.int_inst_queue_writes"]},
    "iq_wakeups":           {"confidence": "soft", "keys": ["board.processor.cores.core.iq.int_inst_queue_wakeup_accesses", "system.cpu.iq.int_inst_queue_wakeup_accesses"]},
    "fp_iq_reads":          {"confidence": "soft", "keys": ["board.processor.cores.core.iq.fp_inst_queue_reads", "system.cpu.iq.fp_inst_queue_reads"]},
    "fp_iq_writes":         {"confidence": "soft", "keys": ["board.processor.cores.core.iq.fp_inst_queue_writes", "system.cpu.iq.fp_inst_queue_writes"]},
    "fp_iq_wakeups":        {"confidence": "soft", "keys": ["board.processor.cores.core.iq.fp_inst_queue_wakeup_accesses", "system.cpu.iq.fp_inst_queue_wakeup_accesses"]},
}
